...
export function SkillCard({
  ...
  index: number;
  onReadMore: () => void;
  /** Grid mode: no tilt, no overlap stacking — the fallback past ~8 skills,
   * where a fanned deck's rotation and negative-z-index dance stop reading
   * as charming and start reading as clutter. */
  flat?: boolean;
}) {

    ...
    <section className="relative bg-[var(--l-cream)] pb-28 md:pb-36">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-14 items-center">
        ...
        <motion.div
          ...
          className="rounded-3xl bg-[var(--l-navy-deep)] text-[var(--l-cream)] p-8 shadow-2xl shadow-black/10 border border-[var(--l-line-dark)]"
        >
          <div className="flex items-center justify-between">
            <div className="text-xs uppercase tracking-[0.14em] text-[var(--l-orange-soft)]">
              Agent Passport
            </div>
            <div className="text-xs font-mono text-[var(--l-cream)]/40">
              #AG-8841
            </div>
          </div>

          <div className="mt-6 text-2xl font-semibold">Invoice Triage Bot</div>
          <div className="text-sm text-[var(--l-cream)]/50">
  ...
  return (
    <div className="flex items-center gap-3 rounded-xl bg-white/[0.04] border border-[var(--l-line-dark)] px-4 py-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="text-[11px] uppercase tracking-wide text-[var(--l-cream)]/40">
          {label}
        </div>

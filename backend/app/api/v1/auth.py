...
async def settings_overview(
    ...
    automation_count is hardcoded to 0: the automations domain module this
    field originally read from was never carried over onto `main` when the
    console was rebuilt (see the port that added this route) — there is no
    automations feature on this branch to count.
    """
